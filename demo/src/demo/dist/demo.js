...
webpackJsonp([0, 1], { 0: function _(t, e, r) {
    r("a7la"), function () {
      throw new Error('Cannot find module "/home/anthony/Workspace/react-toasts/demo/src/demo/src/index.js"');
    }();
  }, BVlg: function BVlg(t, e, r) {
    "use strict";
    function n() {
      f = !1, a._10 = null, a._97 = null;
    }function o(t) {
      function e(e) {
        (t.allRejections || s(l[e].error, t.whitelist || u)) && (l[e].displayId = c++, t.onUnhandled ? (l[e].logged = !0, t.onUnhandled(l[e].displayId, l[e].error)) : (l[e].logged = !0, i(l[e].displayId, l[e].error)));
      }function r(e) {
        l[e].logged && (t.onHandled ? t.onHandled(l[e].displayId, l[e].error) : l[e].onUnhandled || (console.warn("Promise Rejection Handled (id: " + l[e].displayId + "):"), console.warn('  This means you can ignore any previous messages of the form "Possible Unhandled Promise Rejection" with id ' + l[e].displayId + ".")));
          ...
          c = 0,
          l = {};a._10 = function (t) {
        2 === t._81 && l[t._72] && (l[t._72].logged ? r(t._72) : clearTimeout(l[t._72].timeout), delete l[t._72]);
      }, a._97 = function (t, r) {
        0 === t._45 && (t._72 = o++, l[t._72] = { displayId: null, error: r, timeout: setTimeout(e.bind(null, t._72), s(r, u) ? 100 : 2e3), logged: !1 });
      };
    }function i(t, e) {
      ...
      return e.some(function (e) {
        ...
        f = !1;e.disable = n, e.enable = o;
  }, "J7/Q": function J7Q(t, e, r) {
    "use strict";
    function n(t) {
      var e = new o(o._61);return e._81 = 1, e._65 = t, e;
    }var o = r("y/UQ");t.exports = o;var i = n(!0),
        s = n(!1),
        a = n(null),
        u = n(void 0),
        f = n(0),
        c = n("");o.resolve = function (t) {
      if (t instanceof o) return t;if (null === t) return a;if (void 0 === t) return u;if (!0 === t) return i;if (!1 === t) return s;if (0 === t) return f;if ("" === t) return c;if ("object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) || "function" == typeof t) try {
      ...
      var e = Array.prototype.slice.call(t);return new o(function (t, r) {
        function n(s, a) {
          if (a && ("object" == (typeof a === "undefined" ? "undefined" : _typeof(a)) || "function" == typeof a)) {
            if (a instanceof o && a.then === o.prototype.then) {
              for (; 3 === a._81;) {
                a = a._65;
              }return 1 === a._81 ? n(s, a._65) : (2 === a._81 && r(a._65), void a.then(function (t) {
                n(s, t);
              }, r));
            }var u = a.then;if ("function" == typeof u) {
              return void new o(u.bind(a)).then(function (t) {
                n(s, t);
              }, r);
            }
          }e[s] = a, 0 == --i && t(e);
        }if (0 === e.length) return t([]);for (var i = e.length, s = 0; s < e.length; s++) {
          n(s, e[s]);
        }
      });
    }, o.reject = function (t) {
    ...
    (function (e) {
      function r(t) {
        ...
        for (; f < a.length;) {
          var t = f;if (f += 1, a[t].call(), f > c) {
            for (var e = 0, r = a.length - f; e < r; e++) {
              a[e] = a[e + f];
            }a.length -= f, f = 0;
          }
        }a.length = 0, f = 0, u = !1;
        ...
        var e = 1,
            r = new h(t),
            n = document.createTextNode("");return r.observe(n, { characterData: !0 }), function () {
          e = -e, n.data = e;
        };
      }function i(t) {
        return function () {
          ...
          c = 1024,
          l = void 0 !== e ? e : self,
          h = l.MutationObserver || l.WebKitMutationObserver;s = "function" == typeof h ? o(n) : i(n), r.requestFlush = s, r.makeRequestCallFromTimer = i;
    }).call(e, r("Uehh"));
  }, a7la: function a7la(t, e, r) {
    "undefined" == typeof Promise && (r("BVlg").enable(), window.Promise = r("J7/Q")), r("hT7L"), Object.assign = r("nZWx");
    ...
    !function (t) {
      ...
      function e(t) {
        ...
        return this.bodyUsed = !1, this._initBody = function (t) {
          if (this._bodyInit = t, t) {
            if ("string" == typeof t) this._bodyText = t;else if (m.blob && Blob.prototype.isPrototypeOf(t)) this._bodyBlob = t;else if (m.formData && FormData.prototype.isPrototypeOf(t)) this._bodyFormData = t;else if (m.searchParams && URLSearchParams.prototype.isPrototypeOf(t)) this._bodyText = t.toString();else if (m.arrayBuffer && m.blob && w(t)) this._bodyArrayBuffer = c(t.buffer), this._bodyInit = new Blob([this._bodyArrayBuffer]);else {
              if (!m.arrayBuffer || !ArrayBuffer.prototype.isPrototypeOf(t) && !v(t)) throw new Error("unsupported BodyInit type");this._bodyArrayBuffer = c(t);
            }
        ...
        var e = t.toUpperCase();return g.indexOf(e) > -1 ? e : t;
      }function d(t, e) {
        ...
        } else this.url = String(t);if (this.credentials = e.credentials || this.credentials || "omit", !e.headers && this.headers || (this.headers = new o(e.headers)), this.method = h(e.method || this.method || "GET"), this.mode = e.mode || this.mode || null, this.referrer = null, ("GET" === this.method || "HEAD" === this.method) && r) throw new TypeError("Body not allowed for GET or HEAD requests");this._initBody(r);
      }function y(t) {
        ...
        var m = { searchParams: "URLSearchParams" in t, iterable: "Symbol" in t && "iterator" in Symbol, blob: "FileReader" in t && "Blob" in t && function () {
          ...
          }(), formData: "FormData" in t, arrayBuffer: "ArrayBuffer" in t };if (m.arrayBuffer) var _ = ["[object Int8Array]", "[object Uint8Array]", "[object Uint8ClampedArray]", "[object Int16Array]", "[object Uint16Array]", "[object Int32Array]", "[object Uint32Array]", "[object Float32Array]", "[object Float64Array]"],
            w = function w(t) {
        ...
        }, l.call(d.prototype), l.call(b.prototype), b.prototype.clone = function () {
        ...
        };var T = [301, 302, 303, 307, 308];b.redirect = function (t, e) {
          if (-1 === T.indexOf(e)) throw new RangeError("Invalid status code");return new b(null, { status: e, headers: { location: t } });
    ...
    function n(t) {
      ...
      try {
        ...
        a = Object.prototype.propertyIsEnumerable;t.exports = o() ? Object.assign : function (t, e) {
      for (var r, o, u = n(t), f = 1; f < arguments.length; f++) {
        r = Object(arguments[f]);for (var c in r) {
          s.call(r, c) && (u[c] = r[c]);
        }if (i) {
          o = i(r);for (var l = 0; l < o.length; l++) {
            a.call(r, o[l]) && (u[o[l]] = r[o[l]]);
          }
        }
      }return u;
    };
  }, "y/UQ": function yUQ(t, e, r) {
    "use strict";
    function n() {}function o(t) {
      ...
      if ("object" != _typeof(this)) throw new TypeError("Promises must be constructed via new");if ("function" != typeof t) throw new TypeError("not a function");this._45 = 0, this._81 = 0, this._65 = null, this._54 = null, t !== n && p(t, this);
    }function u(t, e, r) {
      return new t.constructor(function (o, i) {
        var s = new a(n);s.then(o, i), f(t, new y(e, r, s));
      });
    }function f(t, e) {
      for (; 3 === t._81;) {
        t = t._65;
      }if (a._10 && a._10(t), 0 === t._81) return 0 === t._45 ? (t._45 = 1, void (t._54 = e)) : 1 === t._45 ? (t._45 = 2, void (t._54 = [t._54, e])) : void t._54.push(e);c(t, e);
    }function c(t, e) {
      b(function () {
        var r = 1 === t._81 ? e.onFulfilled : e.onRejected;if (null === r) return void (1 === t._81 ? l(e.promise, t._65) : h(e.promise, t._65));var n = i(r, t._65);n === _ ? h(e.promise, m) : l(e.promise, n);
      });
    }function l(t, e) {
      if (e === t) return h(t, new TypeError("A promise cannot be resolved with itself."));if (e && ("object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) || "function" == typeof e)) {
        var r = o(e);if (r === _) return h(t, m);if (r === t.then && e instanceof a) return t._81 = 3, t._65 = e, void d(t);if ("function" == typeof r) return void p(r.bind(e), t);
      }t._81 = 1, t._65 = e, d(t);
    }function h(t, e) {
      t._81 = 2, t._65 = e, a._97 && a._97(t, e), d(t);
    }function d(t) {
      if (1 === t._45 && (f(t, t._54), t._54 = null), 2 === t._45) {
      ...
      var r = !1,
        ...
        m = null,
        _ = {};t.exports = a, a._10 = null, a._97 = null, a._61 = n, a.prototype.then = function (t, e) {
      if (this.constructor !== a) return u(this, t, e);var r = new a(n);return f(this, new y(t, e, r)), r;
    };
  } }, [0]);
