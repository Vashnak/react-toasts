(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("react"), require("react-transition-group"));
	else if(typeof define === 'function' && define.amd)
		define(["react", "react-transition-group"], factory);
	else if(typeof exports === 'object')
		exports["react-toasts"] = factory(require("react"), require("react-transition-group"));
	else
		root["react-toasts"] = factory(root["react"], root["react-transition-group"]);
...
var _watchableStore = __webpack_require__(4);

var _watchableStore2 = _interopRequireDefault(_watchableStore);

var _reactTransitionGroup = __webpack_require__(5);
...
// module
exports.push([module.i, ".react-toasts-container{position:absolute;z-index:9999;overflow:hidden;max-height:calc(100vh - 10px);text-align:right}.react-toasts-container .react-toasts{font-family:Arial;display:inline-block;padding:5px 15px;height:50px;line-height:50px;margin-bottom:15px;border-radius:5px}.react-toasts-container .react-toasts-animation-appear-active{animation-name:fadeInDown;animation-duration:.5s;animation-fill-mode:both}.react-toasts-container .react-toasts.success{background-color:#2ecc71}.react-toasts-container .react-toasts.info{background-color:#ecf0f1}.react-toasts-container .react-toasts.warning{background-color:#f1c40f}.react-toasts-container .react-toasts.error{background-color:#e74c3c}", ""]);
...
//# sourceMappingURL=react-toasts.js.map